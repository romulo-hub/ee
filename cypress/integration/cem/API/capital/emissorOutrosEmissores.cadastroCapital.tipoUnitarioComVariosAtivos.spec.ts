...
describe('Emissor Outros Emissores - Cadastro capital com tipo unitário com vários ativos', () => {
    ...
    capitalEmissor.forEach((capitalData: CemModel) => {
        ...
        it('GET Capital Ativo pelo idEmissor - Consultar capital tipo unitário com vários ativos já cadastrado com o evento IPO já homologado', () => {
        ...
        it('GET - Consultar evento IPO já homologado após cadastro capital tipo unitário com vários ativos', () => {
