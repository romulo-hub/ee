...
describe('Emissor Cia Estrangeira - Homologar completo evento Conversão de ações - Capital Tipo Unitário', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('PUT - Homologar completo evento Conversão de ações', () => {
        ...
        it('GET - Consultar capital tipo unitário com um ativo após homologar completo evento Conversão de ações', () => {

            valorUnitarioAposEventoHomologado = 6.0819462
