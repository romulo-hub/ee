...
describe('Emissor Cia Aberta - Cadastro evento Subscrição com add novo ativo já homologado - Capital Tipo Unitário', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('POST - Cadastrar evento Subscrição com add novo ativo já homologado', () => {

            statusEventoCapital = true
            qtdeAtivoPreferencialAlterar = 3788
            qtdeAtivoOrdinarioAlterar = 1147
            justificativaEvento = "Teste"
            valorEventoCapitalAlterar = 4400
            resgatavelNovoAtivoEventoCapital = true
            qtdeAtivosNovoAtivoEventoCapital = 2200
            tagAlongNovoAtivoEventoCapital = 90
        ...
        it('GET - Consultar capital tipo unitário com vários ativos após cadastrar evento Subscrição com add novo ativo já homologado', () => {

            valorUnitarioAposEventoHomologado = 3.2785251
