...
describe('Emissor Outros Emissores - Homologar completo evento Cisão I - Capital Tipo Nominal', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('PUT - Homologar completo evento Cisão I', () => {
        ...
        it('GET - Consultar capital tipo nominal com vários ativos após homologar completo evento Cisão I', () => {
        ...
        it('GET Histórico capital - Consultar no histórico os eventos capital já homologado', () => {
            ...
            cy.getCEM('Capital/' + idEmissor + '/history').then(resp => {
                ...
                assert.isTrue(buscaEventoCisaoI.some(i => i.capital == valorPrecoCapitalAlterar), "valor capital - Cisão I")
