...
describe('Emissor Cia Incentivada - Homologar completo evento Conversão de ações - Validar a mensagem de não permitir homologar completo com o manter restante ativado sem quantidades restantes pendente de homologação - Capital Tipo Nominal', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('PUT - Homologar completo evento Conversão de ações - Validar a mensagem de não permitir homologar completo com o manter restante ativado sem quantidades restantes pendente de homologação', () => {
            ...
            cy.putCEM('capitalEvent/homolog',
                {
                    ...
                    assert.isTrue(resp.body.description.includes('O evento que deve ser mantido não possui quantidade ou montante remanecentes'), 'O evento que deve ser mantido não possui quantidade ou montante remanecentes')
        ...
        it('GET - Consultar capital tipo nominal com um ativo continua sem alteração do evento pendente de homologação', () => {
