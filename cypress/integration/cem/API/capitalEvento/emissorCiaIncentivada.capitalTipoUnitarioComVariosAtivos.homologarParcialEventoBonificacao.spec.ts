...
let qtdeAtivosPreferencialParcial: number
let qtdesAtivosRestanteOrdinario: number
let qtdesAtivosRestantePreferencial: number
let idEventoCapitalIPO: number

describe('Emissor Cia Incentivada - Homologar parcial evento Somar Quantidade dos Ativos - Capital Tipo Unitário', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('POST - Cadastrar evento Somar Quantidade dos Ativos pendente de homologação', () => {
            ...
            qtdeAtivoPreferencialAlterar = 4800
            qtdeAtivoOrdinarioAlterar = 3200
        ...
        it('PUT - Homologar parcial evento Somar Quantidade dos Ativos', () => {

            qtdeAtivosOrdinarioParcial = 2200
            qtdeAtivosPreferencialParcial = 1150
            qtdesAtivosRestanteOrdinario = qtdeAtivoOrdinarioAlterar - qtdeAtivosOrdinarioParcial
            qtdesAtivosRestantePreferencial = qtdeAtivoPreferencialAlterar - qtdeAtivosPreferencialParcial
            ...
            cy.putCEM('capitalEvent/homolog',
                {
                    ...
                    "capitalEventShares": [
                        ...
                        },
                        {
                            ...
                            "shareClassQuantity": {
                                "homologated": qtdeAtivosPreferencialParcial,
        ...
        it('GET - Consultar capital tipo unitário com vários ativos continua sem alteração do evento pendente de homologação', () => {
