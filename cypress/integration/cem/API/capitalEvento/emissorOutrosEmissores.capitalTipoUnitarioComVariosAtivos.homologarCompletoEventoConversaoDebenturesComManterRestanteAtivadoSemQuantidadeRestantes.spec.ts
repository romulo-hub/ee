...
describe('Emissor Outros Emissores - Homologar completo evento Conversão de Debêntures - Validar a mensagem de não permitir homologar completo com o manter restante ativado sem quantidades restantes pendente de homologação - Capital Tipo Unitário', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('PUT - Homologar completo evento Conversão de Debêntures - Validar a mensagem de não permitir homologar completo com o manter restante ativado sem quantidades restantes pendente de homologação', () => {
        ...
        it('GET - Consultar capital tipo unitário com vários ativos já cadastrado continua sem alteração do evento pendente de homologação', () => {
