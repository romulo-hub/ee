...
describe('Emissor Outros Emissores - Homologar completo evento editado Redução de Capital - Capital Tipo Unitário', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('PUT - Editar evento sem homologar', () => {
            ...
            qtdeAtivoOrdinarioAlterar = 4721
            valorPrecoCapitalAlterar = 20254
        ...
        it('PUT - Homologar completo evento editado Redução de Capital', () => {
        ...
        it('GET - Consultar capital tipo unitário com vários ativos após homologar completo evento editado Redução de Capital', () => {
            ...
            valorUnitarioAposEventoHomologado = 2.3803032
        ...
        it('GET Histórico capital - Consultar no histórico os eventos capital já homologado', () => {
            ...
            cy.getCEM('Capital/' + idEmissor + '/history').then(resp => {
                ...
                assert.isTrue(buscaEventoReducaoCapital.some(i => i.capital == valorPrecoCapitalAlterar), "valor capital - Redução de Capital")
