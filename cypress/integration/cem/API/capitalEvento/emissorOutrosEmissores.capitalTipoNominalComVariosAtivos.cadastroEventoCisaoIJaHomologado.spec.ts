...
describe('Emissor Outros Emissores - Cadastro evento Cisão I já homologado - Capital Tipo Nominal', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('GET Histórico capital - Consultar no histórico o capital antes de homologar completo o evento Cisão I', () => {
        ...
        it('POST - Cadastrar evento Cisão I já homologado', () => {

            statusEventoCapital = true
            justificativaEvento = "Teste"
            valorEventoCapitalAlterar = 8462
        ...
        it('GET - Consultar capital tipo nominal com vários ativos após cadastro evento Cisão I já homologado', () => {

            qtdeTotalAtivosAposEventoHomologado = qtdeTotalAtivosAposCadastroCapital
        ...
        it('GET Histórico capital - Consultar no histórico os eventos capital já homologado', () => {
            ...
            cy.getCEM('Capital/' + idEmissor + '/history').then(resp => {
                ...
                assert.isTrue(buscaEventoCisaoI.some(i => i.capital == valorEventoCapitalAlterar), "valor capital - Cisão I")
                assert.isTrue(buscaEventoCisaoI.some(i => i.eventType == "Cisão I"), "Tipo evento capital - Cisão I")
                assert.isTrue(buscaEventoCisaoI.some(i => i.quantity == qtdeTotalAtivosAposEventoHomologado), "Qtdes ativos total capital - Cisão I")
