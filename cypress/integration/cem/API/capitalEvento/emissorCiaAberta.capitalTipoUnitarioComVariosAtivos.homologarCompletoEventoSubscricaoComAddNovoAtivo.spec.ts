...
describe('Emissor Cia Aberta - Homologar completo evento Subscrição com add novo ativo - Capital Tipo Unitário', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('GET Histórico capital - Consultar no histórico o capital antes de homologar completo o evento Subscrição', () => {
        ...
        it('POST - Cadastrar evento Subscrição com add novo ativo pendente de homologação', () => {
        ...
        it('PUT - Homologar completo evento Subscrição com add novo ativo', () => {
        ...
        it('GET - Consultar capital tipo unitário com vários ativos após homologar completo evento Subscrição com add novo ativo', function () {
        ...
        it('GET Histórico capital - Consultar no histórico os eventos capital já homologado', () => {
            ...
            cy.getCEM('Capital/' + idEmissor + '/history').then(resp => {
                ...
                assert.isTrue(buscaEventoSubscricao.some(i => i.quantity == qtdeTotalAtivosAposEventoHomologado), "Qtdes ativos total capital - Subscrição")
