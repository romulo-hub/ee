...
describe('Emissor Cia Aberta - Homologar parcial evento Aumento de Capital com restante desativado - Capital Tipo Nominal', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('PUT - Homologar parcial evento Aumento Capital com restante desativado', () => {
        ...
        it('GET - Consultar capital tipo nominal com um ativo após homologar parcial evento Aumento Capital com restante desativado', () => {
