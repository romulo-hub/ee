...
import { EnumApi, EnumTipoEventoCapital, EnumTipoPrecoCapital } from '../../utilitarios/enum.utilitario'
...
let idTipoAtivoPreferencialCapital: number = 2
...
let valorRestanteEventoCapital: number
let idEventoRestanteCapital: number

describe('Emissor Cia Aberta - Homologar parcial evento Aumento de Capital com o restante ativado - Capital Tipo Nominal', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('GET - Consultar capital tipo nominal com um ativo já cadastrado com o evento IPO já homologado', () => {
        ...
        it('GET Histórico capital - Consultar no histórico o capital antes de homologar parcial o evento Aumento de Capital', () => {
        ...
        it('POST - Cadastrar evento Aumento Capital pendente de homologação', () => {
            ...
            valorEventoCapitalAlterar = 20462
        ...
        it('PUT - Homologar parcial evento Aumento Capital', () => {

            
            valorEventoCapitalParcial = valorEventoCapitalAlterar - 4100
            const qtdeAtivosPreferencialCapitalRemaining = qtdeAtivosPreferencialCapital - 1000
                    ...
                    "capitalEventShares": [
                        {
                            ...
                            "shareClassQuantity": {
                                "homologated": qtdeAtivosPreferencialCapitalRemaining,
                                "approved": qtdeAtivosPreferencialCapitalRemaining,
                                "remainder": 0,
                                "keepPending": false,
                            },
                            "justificationDescripition": justificativaEvento
        ...
        it('GET - Consultar capital tipo nominal com um ativo após homologar parcial evento Aumento Capital', () => {

            valorCapitalTotalAposEventoHomologado = valorPrecoCapital + valorEventoCapitalParcial
        ...
        it('GET lista eventos pendente de homologação - Consultar evento capital restante após homologação parcial', () => {
            ...
            valorRestanteEventoCapital = valorEventoCapitalAlterar - valorEventoCapitalParcial
            ...
            cy.getCEM('capitalEvent/' + idEmissor + '/homologate-list').then(resp => {
                ...
                expect(resp.body[0]).to.have.property('capitalPriceValue', valorRestanteEventoCapital)
                expect(resp.body[0]).to.have.property('issuerCode', idEmissor)
                expect(resp.body[0]).to.have.property('capitalEventTypeCode', idTipoEventoCapital)
                expect(resp.body[0].capitalEventStatus).to.be.eq(0)
                expect(resp.body[0]).to.have.property('capitalEventTypeDescription', "Aumento de Capital sem Emissão de Ações")
