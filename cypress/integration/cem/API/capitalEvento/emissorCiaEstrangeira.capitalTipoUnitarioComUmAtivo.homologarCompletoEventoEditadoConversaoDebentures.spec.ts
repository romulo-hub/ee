...
describe('Emissor Cia Estrangeira - Homologar completo evento editado Conversão de Debêntures - Capital Tipo Unitário', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('PUT - Homologar completo evento editado Conversão de Debêntures', () => {
        ...
        it('GET - Consultar capital tipo unitário com um ativo após homologar completo evento editado Conversão de Debêntures', () => {

            valorCapitalAposEventoHomologado = valorPrecoCapital + valorEventoCapitalAlterar
            qtdesAtivosOrdinarioTotalAposEventoHomologado = qtdeAtivosOrdinarioCapital + qtdeAtivoAlterar
            valorUnitarioAposEventoHomologado = 8.0227272
