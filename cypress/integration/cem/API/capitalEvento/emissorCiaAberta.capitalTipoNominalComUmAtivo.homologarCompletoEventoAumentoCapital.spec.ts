...
describe('Emissor Cia Aberta - Homologar completo evento Aumento de Capital - Capital Tipo Nominal', () => {
    ...
    capitalEventoEmissor.forEach((capitalData: CemModel) => {
        ...
        it('POST - Cadastrar evento Aumento Capital pendente de homologação', () => {
            ...
            valorEventoCapitalAlterar = 12548
        ...
        it('PUT - Homologar completo evento Aumento Capital', () => {
        ...
        it('GET - Consultar capital tipo nominal com um ativo após homologar completo evento Aumento Capital', () => {
