...
describe('Tipo emissor BDR NP com capital tipo unitario com um ativo cadastrado - Validar as informações no histórico capital após cadastro do capital com o evento Capital Inicial e cadastros de outros eventos já homologados', () => {
    ...
    capitalEmissor.forEach((capitalData: CemModel) => {
        ...
        before(() => {
            ...
            capitalNovoEventoUtilitario.capitalEventoApi().emissorSemCapitalSocialNovoEventoJaHomologado().criarNovoEventoAumentoCapitalJaHomologadoComUmAtivo(capitalData.Emissor)
            capitalNovoEventoUtilitario.capitalEventoApi().emissorSemCapitalSocialNovoEventoJaHomologado().criarNovoEventoReducaoCapitalJaHomologadoComUmAtivo(capitalData.Emissor)
            capitalNovoEventoUtilitario.capitalEventoApi().emissorSemCapitalSocialNovoEventoJaHomologado().criarNovoEventoConversaoAcoesJaHomologadoComUmAtivo(capitalData.Emissor)
            capitalNovoEventoUtilitario.capitalEventoApi().emissorSemCapitalSocialNovoEventoJaHomologado().criarNovoEventoConversaoDebenturesJaHomologadoComUmAtivo(capitalData.Emissor)
            capitalNovoEventoUtilitario.capitalEventoApi().emissorSemCapitalSocialNovoEventoJaHomologado().criarNovoEventoCisaoIIJaHomologadoComUmAtivo(capitalData.Emissor)
        ...
        it("Validar os detalhes no histórico do capital após cadastro do evento Aumento de Capital já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().valorUnitAcaoHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'R$ 0,00')
