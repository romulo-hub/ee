...
describe('Tipo emissor BDR NP - Validação do nome valor do evento e nome quantidade dos ativos conforme evento - grid eventos a homologar', () => {
  ...
  capitalEmissor.forEach((capitalData: CemModel) => {
    ...
    it("Validar a exibição do nome quantidade final e nome capital final - Ajuste - grid eventos a homologar", () => {
      ...
      capitalEventoPage.gridEventosAHomologarModal().valorCapitalEvento('[placeholder="Capital Final"]').should('have.value', 'R$ 0,00')
