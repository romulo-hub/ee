...
describe('Tipo emissor BDR NP com capital tipo nominal com vários ativos cadastrado - Validar as informações no histórico capital após cadastro do capital com o evento Capital Inicial e cadastros de outros eventos já homologados', () => {
    ...
    capitalEmissor.forEach((capitalData: CemModel) => {
        ...
        before(() => {
            ...
            capitalNovoEventoUtilitario.capitalEventoApi().emissorSemCapitalSocialNovoEventoJaHomologado().criarNovoEventoAumentoCapitalJaHomologadoNominalComVariosAtivos(capitalData.Emissor)
            capitalNovoEventoUtilitario.capitalEventoApi().emissorSemCapitalSocialNovoEventoJaHomologado().criarNovoEventoReducaoCapitalJaHomologadoNominalComVariosAtivos(capitalData.Emissor)
            capitalNovoEventoUtilitario.capitalEventoApi().emissorSemCapitalSocialNovoEventoJaHomologado().criarNovoEventoConversaoAcoesJaHomologadoNominalComVariosAtivos(capitalData.Emissor)
            capitalNovoEventoUtilitario.capitalEventoApi().emissorSemCapitalSocialNovoEventoJaHomologado().criarNovoEventoConversaoDebenturesJaHomologadoNominalComVariosAtivos(capitalData.Emissor)
            capitalNovoEventoUtilitario.capitalEventoApi().emissorSemCapitalSocialNovoEventoJaHomologado().criarNovoEventoCisaoIIJaHomologadoNominalComVariosAtivos(capitalData.Emissor)
        ...
        it("Validar os detalhes no histórico do capital após cadastro do evento Aumento de Capital já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosOrdinariaHistoricoCapital().should('be.visible').should('have.value', '1.000')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosPreferencialHistoricoCapital().should('be.visible').should('have.value', '2.000')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosTotalHistoricoCapital().should('be.visible').should('have.value', '3.000')
        ...
        it("Validar os detalhes no histórico do capital após cadastro do evento Redução de Capital já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosPreferencialHistoricoCapital().should('be.visible').should('have.value', '1.860')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosTotalHistoricoCapital().should('be.visible').should('have.value', '3.720')
                cy.get('[class="mat-table cdk-table"]').within(() => {
        ...
        it("Validar os detalhes no histórico do capital após cadastro do evento Conversão de ações já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().nominalUnitarioHistoricoCapital().should('be.visible').should('have.value', 'Nominal')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().valorUnitAcaoHistoricoCapital().should('be.visible').should('have.value', 'R$ 3.200,00')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosOrdinariaHistoricoCapital().should('be.visible').should('have.value', '2.160')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosPreferencialHistoricoCapital().should('be.visible').should('have.value', '2.160')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosTotalHistoricoCapital().should('be.visible').should('have.value', '4.320')
                cy.get('[class="mat-table cdk-table"]').within(() => {
        ...
        it("Validar os detalhes no histórico do capital após cadastro do evento Conversão Debêntures já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().nominalUnitarioHistoricoCapital().should('be.visible').should('have.value', 'Nominal')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().valorUnitAcaoHistoricoCapital().should('be.visible').should('have.value', 'R$ 3.200,00')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosOrdinariaHistoricoCapital().should('be.visible').should('have.value', '3.222')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosPreferencialHistoricoCapital().should('be.visible').should('have.value', '3.222')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosTotalHistoricoCapital().should('be.visible').should('have.value', '6.444')
                cy.get('[class="mat-table cdk-table"]').within(() => {
        ...
        it("Validar os detalhes no histórico do capital após cadastro do evento Cisão II já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().nominalUnitarioHistoricoCapital().should('be.visible').should('have.value', 'Nominal')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().valorUnitAcaoHistoricoCapital().should('be.visible').should('have.value', 'R$ 3.200,00')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosOrdinariaHistoricoCapital().should('be.visible').should('have.value', '2.200')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosPreferencialHistoricoCapital().should('be.visible').should('have.value', '4.545')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosTotalHistoricoCapital().should('be.visible').should('have.value', '6.745')
                cy.get('[class="mat-table cdk-table"]').within(() => {
