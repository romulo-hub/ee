...
describe('Tipo emissor Cia Estrangeira com capital tipo unitário com um ativo cadastrado - Validar as informações no histórico capital após cadastro do capital com o evento Capital Inicial e cadastros de outros eventos já homologados', () => {
    ...
    capitalEmissor.forEach((capitalData: CemModel) => {
        ...
        it("Validar os detalhes no histórico do capital após cadastro do evento Aumento de Capital já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().valorUnitAcaoHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'R$ 35,80')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosOrdinariaHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', '1.200')
        ...
        it("Validar os detalhes no histórico do capital após cadastro do evento Redução de Capital já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().nominalUnitarioHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'Unitário')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().valorUnitAcaoHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'R$ 12,07')
        ...
        it("Validar os detalhes no histórico do capital após cadastro do evento Conversão de ações já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().capitalSocialHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'R$ 22.450,00')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().nominalUnitarioHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'Unitário')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().valorUnitAcaoHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'R$ 10,39')
        ...
        it("Validar os detalhes no histórico do capital após cadastro do evento Conversão Debêntures já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().nominalUnitarioHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'Unitário')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().valorUnitAcaoHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'R$ 7,84')
        ...
        it("Validar os detalhes no histórico do capital após cadastro do evento Cisão I já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().nominalUnitarioHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'Unitário')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().valorUnitAcaoHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'R$ 33,76')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosOrdinariaHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', '1.200')
        ...
        it("Validar os detalhes no histórico do capital após cadastro do capital com o evento Capital Inicial já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().nominalUnitarioHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'Unitário')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().valorUnitAcaoHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'R$ 25,00')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosOrdinariaHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', '1.200')
        ...
        it("Validar os detalhes no histórico do capital após cadastro do capital com o evento Cisão II já homologado", function () {
            ...
            cy.get('app-history-detail').get('[class="modal"]').within(() => {
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().nominalUnitarioHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'Unitário')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().valorUnitAcaoHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', 'R$ 6,26')
                ...
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosPreferencialHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', '2.345')
                capitalPage.historicoCapitalModal().detalhesHistoricoCapitalModal().quantidadeAtivosTotalHistoricoCapital().should('be.visible').should('not.be.focused').should('have.value', '4.545')
