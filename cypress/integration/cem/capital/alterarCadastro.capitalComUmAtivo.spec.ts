...
describe('Tipo emissor Cia Estrangeira com capital tipo nominal com um ativo cadastrado - Alterar o cadastro do capital do emissor', () => {
  ...
  capitalEmissor.forEach((capitalData: CemModel) => {
    ...
    it("Alterar o cadastro do capital do emissor já cadastrado para o tipo Unitário e consultar esse registro na busca de emissores", () => {
      ...
      capitalPage.valorUnitAcao().should('not.be.enabled').should('have.value', 'R$ 21,9230769')
    ...
    it("Alterar o cadastro do capital do emissor já cadastrado para o tipo Nominal e consultar esse registro na busca de emissores", () => {
      ...
      capitalPage.valorUnitAcao().should('be.enabled').clear().type("3.252,35").blur()
      cy.get('#resp-table-body').within(() => {
      ...
      capitalPage.novoAtivoModal().flagResgatavelAlterarCapital().last().click()
